...
namespace SoftControllers
{
    ...
    /// </summary>
    public class RaisingEdgeDetector
    {
        bool clk = true;
        bool q = true;
    ...
    public class PidController
    {
        ...
        public void CLK(double sp, double pv, int elapsedMilliseconds)
        {
            ...
            iTerm = PidController.Clamp(iTerm, CVLow, CVHigh);

            if (Ki == 0.0)
                iTerm = 0.0;

            OV = PidController.Clamp(Kp * error + iTerm + Kd * dError, CVLow, CVHigh);
        }
